...
import TranslationGroupSelector from "./components/translation-group-selector";
...
const translationGroups = [
  {
    id: 1,
    name: "Client Web",
    description: "Translations for web application",
    icon: "mdi:web"
  },
  {
    id: 2,
    name: "Manager",
    description: "Translations for manager portal",
    icon: "mdi:account-tie"
  },
  {
    id: 3,
    name: "Mobile App",
    description: "Translations for mobile application",
    icon: "mdi:cellphone"
  }
];
...
const TranslationsPage = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <TranslationGroupSelector
        groups={translationGroups}
        selectedGroup={selectedTranslationGroup}
        onSelect={operations.setSelectedTranslationGroup}
        t={t}
      />
