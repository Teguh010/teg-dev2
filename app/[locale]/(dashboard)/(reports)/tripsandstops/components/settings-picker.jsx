        ...
        <PopoverContent className="w-[90%] md:w-auto py-4" align="center">
          <div className="flex flex-row space-x-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select value={tripMode} onValueChange={(value) => setTripMode(value === "" ? null : value)}>
                  <SelectTrigger>
                    <SelectValue
                  ...
                  <SelectContent>
                    <SelectItem
                      value=""
                    >
                      {firstUpperLetter(t('general.not_selected'))}
                    </SelectItem>
                    <SelectItem
                      value="1"
                    >
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="showStationaryIgnition"
                    checked={showStationaryIgnition}
                    onCheckedChange={setShowStationaryIgnition}
                  />
                  <Label htmlFor="showStationaryIgnition" className="text-sm font-medium">
                    {firstUpperLetter(t('trips_and_stops.show_stationary_ignition'))}
                  </Label>
                </div>
              </div>
          ...
          <div className="flex flex-row w-full justify-end gap-1 p-2">
            <Button
              ...
              color="dark"
              size="xxs"
              onClick={() => (setMinMoving(null), setMinStationary(null), setTripMode(""), setShowStationaryIgnition(true), setSchedules([]))}
            >
              {t('reset')}
            </Button>
