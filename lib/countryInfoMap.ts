export const countryInfoMap: Record<string, { name: string; flag: string }> = {
  AFG: { name: 'Afghanistan', flag: '🇦🇫' },
  ALA: { name: 'Aland Islands', flag: '🇦🇽' },
  ...
  COG: { name: 'Congo', flag: '🇨🇬' },
  COD: { name: 'Congo, Democratic Republic of the', flag: '🇨🇩' },
  COK: { name: 'Cook Islands', flag: '🇨🇰' },
  CRI: { name: 'Costa Rica', flag: '🇨🇷' },
  CIV: { name: "Cote d'Ivoire", flag: '🇨🇮' },
  ...
  MAC: { name: 'Macao', flag: '🇲🇴' },
  MKD: { name: 'Macedonia, the Former Yugoslav Republic of', flag: '🇲🇰' },
  ...
  SHN: { name: 'Saint Helena, Ascension and Tristan da Cunha', flag: '🇸🇭' },
  ...
  SGS: { name: 'South Georgia and the South Sandwich Islands', flag: '🇬🇸' },
  ...
  UMI: { name: 'United States Minor Outlying Islands', flag: '🇺🇲' },
