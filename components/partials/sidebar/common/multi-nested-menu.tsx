...
interface MultiNestedMenuProps {
  subItem: MenuItem;
  subIndex: number;
  activeMultiMenu: number | null;
}

const MultiNestedMenu: React.FC<MultiNestedMenuProps> = ({ subItem, subIndex, activeMultiMenu }) => {
                ...
                >
                  <span
                    className={cn(
                      ...
                      {
                        "border-primary": isLocationMatch(item.href, locationName),
                      }
                    )}
                  />
