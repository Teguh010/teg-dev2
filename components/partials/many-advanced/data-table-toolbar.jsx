...
export function DataTableToolbar({ table, ifSearch, searchList, pickers, groups, exports, bulk, hideViewOptions = false }) {
  ...
  return (
    <div className="flex justify-between flex-col lg:flex-row lg:items-center">
      ...
      <div className="mt-2 lg:mt-0 flex justify-between">
        ...
        {groups && groups(table)}
        {table.getAllColumns().length > 1 && !hideViewOptions &&
