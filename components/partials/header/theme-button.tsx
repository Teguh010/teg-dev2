    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative lg:h-9 lg:w-9 h-8 w-8 hover:bg-default-100 dark:hover:bg-default-200 
      ...
      <DropdownMenuContent align="end" className="p-2">
        ...
        >
          ...
          <span className="mr-2 capitalize">{t('general.light')}</span>
          <Check
        ...
        >
          ...
          <span className="mr-2 capitalize">{t('general.dark')}</span>
          <Check
