...
type CheckboxColor = "default" | "secondary" | "destructive" | "warning" | "info" | "success" | "dark";
type CheckboxVariant = "solid" | "plain" | "faded" | "filled" | "outline" | "filled-outline";
type CheckboxRadius = "none" | "sm" | "base" | "md" | "lg" | "xl";
    ...
    <>
      {children ? (
        <div className="flex items-center">
          ...
          {/* Use native label if custom Label does not accept children */}
          <label
            htmlFor={props.id}
            className={cn(
